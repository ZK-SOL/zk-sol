...
export function __wbg_merklenodewasm_free(a: number, b: number): void;
export function merklenodewasm_deserialize(a: number, b: number, c: number): void;
export function merklenodewasm_mod_input(a: number, b: number, c: number): void;
export function merklenodewasm_hash(a: number, b: number): number;
export function merklenodewasm_get_hash(a: number, b: number): void;
export function merklenodewasm_from_children(a: number, b: number): number;
export function merklenodewasm_generate_proof_path(a: number, b: number, c: number): void;
