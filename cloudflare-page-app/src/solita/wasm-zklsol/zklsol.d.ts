...
* @returns {Uint8Array}
*/
  static mod_input(input: Uint8Array): Uint8Array;
/**
* @param {Uint8Array} data
* @returns {MerkleNodeWasm}
*/
  static hash(data: Uint8Array): MerkleNodeWasm;
/**
* @param {MerkleNodeWasm} left
* @param {MerkleNodeWasm} right
* @returns {MerkleNodeWasm}
*/
  static from_children(left: MerkleNodeWasm, right: MerkleNodeWasm): MerkleNodeWasm;
/**
* @param {number} depth
* @param {bigint} leaf_index
* @returns {any}
*/
  static generate_proof_path(depth: number, leaf_index: bigint): any;
/**
*/
  readonly get_hash: Uint8Array;
}
/**
